...
from .views import ActualizarTrabajador2, ActualizarBaja, NominaList2, RegistrarNominaView2
# from .views import RegistrBajasView
from .views import NominaDePagoView, NominaDePagoView2
...
urlpatterns = [
    ...
    path('nomina2/', NominaList2.as_view(), name='nomina_list2'),
    ...
    path('registrar_nomina2/', RegistrarNominaView2.as_view(), name='registrar_nomina2'),
    ...
    path('actualizar_baja/<int:pk>/', ActualizarBaja.as_view(), name='actualizar_baja'),
    ...
    path('pago2/', NominaDePagoView2.as_view(), name='pago2'),
