...
from .views import PruebaView, ImprimirDesglose
...
urlpatterns = [
    ...
    path('mostrar_conteo_billetes2/', ShowContadorBilletes.as_view(), name='mostrar_conteo_billetes2'),
    path('mostrar_conteo_billetes/', CalculadoraBilletes2.as_view(), name='mostrar_conteo_billetes'),
    ...
    path('imprimir-desglose/<int:pk>', ImprimirDesglose.as_view(), name='imprimir-desglose'),
